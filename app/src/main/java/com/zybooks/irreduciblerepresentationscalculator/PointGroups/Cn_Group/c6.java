...
public class c6 extends AppCompatActivity {
    ...
    public void result(View view) {
        ...
        EditText value2 = findViewById(R.id.c6_2c6_user_input);
        EditText value3 = findViewById(R.id.c6_2c3_user_input);
