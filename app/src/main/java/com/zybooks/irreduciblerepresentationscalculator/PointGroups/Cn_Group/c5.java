...
public class c5 extends AppCompatActivity {
    ...
    public void result(View view) {
        EditText value = findViewById(R.id.c5_e_user_input);
        EditText value2 = findViewById(R.id.c5_c5_2_user_input);
        EditText value3 = findViewById(R.id.c5_c5_3_user_input);
        EditText value4 = findViewById(R.id.c5_c5_4_user_input);
