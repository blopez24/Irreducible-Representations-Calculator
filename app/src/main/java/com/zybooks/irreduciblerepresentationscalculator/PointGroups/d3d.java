...
public class d3d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView d3d_descr = findViewById(R.id.d3d_descr);
        d3d_descr.setText(HtmlCompat.fromHtml(
                "Enter the characters for the reducible representation of the D<sub>3d</sub> point group below.", HtmlCompat.FROM_HTML_MODE_LEGACY));

        TextView a = findViewById(R.id.d3d_2c3);
        a.setText(HtmlCompat.fromHtml("2C<sub>3</sub>", HtmlCompat.FROM_HTML_MODE_LEGACY));
        TextView b = findViewById(R.id.d3d_3c2);
    ...
    public void result(View view) {
        EditText value1 = findViewById(R.id.d3d_e_user_input);
        ...
        Button reset = findViewById(R.id.d3d_reset);
        Button button = findViewById(R.id.d3d_submit);
        TextView answerText = findViewById(R.id.d3d_text);
        TextView answer = findViewById(R.id.d3d_answer);
        ...
        if (TextUtils.isEmpty(value1.getText().toString())
            ...
            TableData td = new TableData(getApplicationContext(),"d3d");
            int[] input = new int[6];
